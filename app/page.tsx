      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2">
            <Link href="/app" className="px-4 py-2 text-sm text-zinc-500 hover:text-white transition-colors">
              Open App
            </Link>
            <button
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-white/[0.07] bg-[#080808] px-6 py-5 flex flex-col gap-3">
            ...
            <div className="flex gap-2 pt-3 border-t border-white/[0.07]">
              <Link href="/app" className="flex-1 text-center text-sm border border-white/10 text-zinc-300 px-4 py-2.5 rounded-xl">Open App</Link>
      ...
      <footer className="border-t border-white/[0.05] py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-zinc-700">
            <Link href="/app" className="hover:text-zinc-400 transition-colors">Open App</Link>
